...
const data = {
    countries: {
        japan:
        {
            ...
            activities: [
                {
                    name: "Climbing",
                    description: "The official climbing season of Mt Fuji is only during summer (from July to September), and thousands of people visit there during the season. Various trails are available and climbing takes around 4–8 hours one way. Check out the link below for more details about Mt Fuji climbing!",
                    images: "",
                },
                {
                    name: "Oshino Hakkai",
                    description: "Oshino Hakkai (忍野八海) is a traditional Japanese village set near the Fuji Five Lake area. The village consist of 8 ponds that are formed from the spring water from the snow melt of Mt Fuji.",
                    images: "",
                },
                {
                    name: "Lake Tanuki",
                ...
                },
                {
                    ...
                    description: "Fuji Safari Park (富士サファリパーク) is a large wildlife park near Mt Fuji. Visitors can take a safari tour through the park seeing freely roaming animals such as lions, elephants, tigers, rhinoceroses, giraffes and more by park buses or their own cars. From spring to autumn, night safari tour is also available.",
                    images: "",
                },
            ]
        },
        ...
        philippines:
        {
            ...
            activities: [
                ...
                {
                    name: "Island hopping",
                    description: "Island hopping is a prime activity in Boracay, as a good number of tropical islands can easily be reached by boat tours. Crocodile Island, Crystal Cove (aka Lauren), and Magic Island are the 3 closest and most popular islands to visit from Boracay.",
                    images: "",
                },
                {
                    name: "Snorkelling",
                    description: "Boracay Island has its fair share of great snorkelling spots. The best beach for snorkelling in Boracay is Bulalog. Located on the east coast of the island, it hosts an impressive marine life accessible from the beach. The downside is that it is often crowded with snorkellers.",
                    images: "",
                },
                {
                    name: "Scuba diving",
                    description: "The waters surrounding the island host around 25 dive sites that are reachable via a short boat ride. The most famous dive site near Boracay is Crocodile Island. It’s especially good for underwater photographers as it hosts many critters and nudibranchs. The best time to dive in Boracay is from April to June.",
                    images: "",
                },
            ]
        },
        ...
        australia: {
            tourist: "Sydney Opera House",
            country: "Australia",
            description: 'The Sydney Opera House is a multi-venue performing arts centre in Sydney, Australia. Located on the foreshore of Sydney Harbour, it is widely regarded as one of the worlds most famous and distinctive buildings and a masterpiece of 20th-century architecture.',
            background: "",
            about: {
        ...
        iceland: {
            tourist: "Grindavík",
            country: "Iceland",
            description: 'A trip to the Blue Lagoon in the winter is eerie and wonderful. Watching as snow falls from the jet-black December sky, or as northern lights dance across it, while soaking in the heated water is sublime. But the heated water, which ranges 37-39°C (98-102°F), is heavenly during any time of year.',
            background: "",
            about: {
                explore: "The Blue Lagoon in Iceland is a modern wonder of the world tucked away in a jet-black lava field. The geothermally heated waters of this famous spa are renowned for their skin healing properties. Wispy plumes of steam rise off its milky-blue waters as mountains tower on the horizon, giving it a supernatural feeling.",
                link: "",
                history: "This famous Iceland lagoon is a manmade geothermally heated spa, which is located on the Reykjanes Peninsula – around 50 minutes from Reykjavik. It was founded in 1981 and quickly became one of Iceland's most popular tourist attractions. The lagoon’s milky waters are rich in minerals and help soothe skin conditions. Set in the heart of an 800-year-old lava field – it's a starkly beautiful place that was named one of the 25 modern wonders of the world by National Geographic. No visit to Iceland would be complete without a trip to the Blue Lagoon!",
                picture: "",
            },
            activities: [
                {
        ...
        canada: {
            tourist: "Banff National Park",
            country: "Canada",
            description: 'Rocky Mountain peaks, turquoise glacial lakes, and adventure come together in Banff National Park - Canada’s first national park and the flagship of the nation’s park system. Banff is part of the Canadian Rocky Mountain Parks UNESCO World Heritage Site.',
            background: "",
            about: {
            ...
            activities: [
                {
                    ...
                    description: "Banff and Jasper have a rich and varied history, which is showcased in several museums, including The Cave and Basin National Historic Site in Banff and the Jasper-Yellowhead Museum & Archives in Jasper.",
                    images: "",
                },
                {
                    name: "Maligne lake",
                    description: "There's no denying a visit to Jasper's stunning alpine lake, and a boat ride out to the iconic Spirit Island, will be a highlight of your trip. Make a day out of it with a short hike and a fabulous meal at one of the great dining options, including The View.",
                    images: "",
                },
                {
                    name: "Banff gondola",
        ...
        egypt: {
            ...
            background: "",
            about: {
                explore: "One of the most interesting fun facts about the Great Pyramid of Giza is that it's the oldest and last remaining of the original seven world wonders. This pyramid is also the oldest and largest of the nine at the Giza Necropolis, and is the final resting place of king Khufu",
                link: "",
                history: "The Giza Pyramids, built to endure an eternity, have done just that. The monumental tombs are relics of Egypt's Old Kingdom era and were constructed some 4,500 years ago. Egypt's pharaohs expected to become gods in the afterlife. To prepare for the next world they erected temples to the gods and massive pyramid tombs for themselves—filled with all the things each ruler would need to guide and sustain himself in the next world",
                picture: "",
            },
            activities: [
                {
        ...
        africa: {
            tourist: "Kruger National Park",
            country: "South Africa",
            description: 'With all the wildlife that calls Africa home, Kruger National Park in northeastern South Africa is home to all the continents most famous species, including over 12,000 elephants, 27,000 African Buffalo, 2,000 leopards, and 2,800 lions. Its also regarded as the most likely place in the world to see a leopard',
            background: "",
            about: {
                explore: "Home to some of the most impressive fauna in the world, Africa has long been a safari destination for travelers and adventurers. Of all the National Parks in Africa and of all the possible safaris travelers could possibly go on, those offered by Kruger National Park are simply the best available. Being home to all the African Big Five as well as the most likely place in the world to spot a leopard, Kruger National Park is a must-visit location for any lover of wildlife.",
                link: "",
                history: "The legend surrounding this park emanates from species of wildlife, the landscape, and the ease with which travelers can experience them. Those planning a trip to Kruger National Park will have a number of safari options available to them, giving them the chance to experience the park they want. And with the park being home to Africa’s Big Five: Elephant, Lion, Rhino, Leopard, and Buffalo, travelers to the park will leave with incredible memories they wouldn’t be able to find anywhere else.",
                picture: "",
            },
            activities: [
                {
    ...
    // carousell: [
    //     { src: "jacky-lo-kCNf42AH5RM-unsplash.jpg" },
    //     { src: "wildlife2.jpg" },
    //     { src: "about.jpg" },
    //     { src: "history1.jpg" },
    // ]
